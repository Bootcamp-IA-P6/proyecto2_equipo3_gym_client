  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (userToEdit) {
        ...
        // Si el usuario está marcado como inactivo en la base de datos (userToEdit.is_active === false)
        // pero estamos guardando el formulario, llamamos al endpoint de activación primero.
        if (userToEdit.is_active === false) {
           // Asegúrate de tener esta función definida en tu userService.js
           await userService.activateUser(userToEdit.id);
        }
